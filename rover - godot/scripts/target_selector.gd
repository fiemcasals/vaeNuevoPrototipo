...
@onready var list_container: VBoxContainer = $PanelContainer/VBoxContainer/ScrollContainer/ListContainer
...
func _create_target_button(target_data: Dictionary) -> void:
...
func _on_target_button_pressed(target_data: Dictionary) -> void:
	visible = false
